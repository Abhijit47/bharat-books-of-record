...
import { Route as DemoPostsRouteImport } from './routes/demo/posts'
...
const DemoPostsRoute = DemoPostsRouteImport.update({
  id: '/demo/posts',
  path: '/demo/posts',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/demo/posts': typeof DemoPostsRoute
...
export interface RootRouteChildren {
  ...
  DemoPostsRoute: typeof DemoPostsRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/demo/posts': {
      ...
      path: '/demo/posts'
      fullPath: '/demo/posts'
      preLoaderRoute: typeof DemoPostsRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/demo/drizzle': {
      id: '/demo/drizzle'
